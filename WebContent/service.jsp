...
<!-- Mirrored from responsivewebinc.com/premium/ericka351/orange/service.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Jan 2015 10:27:18 GMT -->
<head>
		<meta charset="utf-8">
		<!-- Title here -->
		<title>Our Services - My Scarp Collector</title>
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-4 col-sm-4">
            <!-- Logo and site link -->
            <div class="logo">
               <h1><a href="index-2.html">Ericka<span class="color">.</span></a></h1>
            </div>
         </div>
         ...
         <div class="col-md-12">
               ...
               <div class="row">
                  <div class="col-md-12">
                     ...
                     <div class="hero">
                        ...
                        <!-- para -->
                        <p>We Provide Our  Scrap Collector Services for different Organization  </p>
                     </div>
                     <!-- Service -->
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="serv-a">
                              <div class="serv">
                                 ...
                                 <h4>Individual</h4>
                                 <!-- Service para -->
                                 <p>My Scrap Collector provide service to individual,like home or any individual person who have scrap material can call us.</p>
                              </div>
                           </div>
                           ...
                           <div class="serv-b">
                              <div class="serv">
                                 ...
                                 <h4>Society</h4>
                                 <p>My Scrap Collector provide services to society like in a building,offices,mahada society who have scrap material can call us.</p>
                              </div>
                           </div>
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="serv-a">
                              <div class="serv">
                                 ...
                                 <h4>Industry</h4>
                                 <p>My Scarp Collector provide services for industry like ,Hotel industry ,Health,IT,Bank,hospital who  have scrap can call us.</p>
                              </div>
                           </div>
                           ...
                           <div class="serv-b">
                              <div class="serv">
                                 ...
                                 <h4>Organization</h4>
                                 <p>My Scrap Collector provide services for organization like Office, Companies,shops, Bank, Courier services who have scrap can call us.</p>
                              </div>
                           </div>
            ...
            <div class="cta">
               <div class="row">
                  <div class="col-md-9">
                     <!-- First line -->
                     <p class="cbig">Any  One Can Call My Scrap Collector Person.</p>
                     <!-- Second line -->
                     <p class="csmall">Any Individual Person,home,shops,office,companies, society,bank or any one can call us .</p>
                  </div>
                  <div class="col-md-2">
                     <!-- Button -->
                     <div class="button"><a href="#">Call Us</a></div>
                  </div>
               </div>
            </div>
