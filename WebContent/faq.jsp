...
<!-- Mirrored from responsivewebinc.com/premium/ericka351/orange/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Jan 2015 10:27:18 GMT -->
<head>
		<meta charset="utf-8">
		<!-- Title here -->
		<title>FAQ - Ericka</title>
						...
						<div class="panel">
							<div class="panel-heading">
								<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
									...
									<h5 class="panel-title"><i class="fa fa-plus"></i> Proin porttitor eros a ante molestie gravida ?</h5>
								</a>
							</div>
						...
						<div class="panel">
							<div class="panel-heading">
								<a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
									<h5 class="panel-title"><i class="fa fa-plus"></i> Proin porttitor eorbi dictum nibh gravida ?</h5>
								</a>
							</div>
						...
						<div class="panel">
							<div class="panel-heading">
								<a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
									<h5 class="panel-title"><i class="fa fa-plus"></i> In vitae adipiscing adipiscing enim gravida ?</h5>
								</a>
							</div>
						...
						<div class="panel">
							<div class="panel-heading">
								<a data-toggle="collapse" data-parent="#accordion" href="#collapseFour">
									<h5 class="panel-title"><i class="fa fa-plus"></i> Sed a interdum mauris molestie gravida ?</h5>
								</a>
							</div>
						...
						<div class="panel">
							<div class="panel-heading">
								<a data-toggle="collapse" data-parent="#accordion" href="#collapseFive">
									<h5 class="panel-title"><i class="fa fa-plus"></i> Nullam in urna est urna molestie gravida ?</h5>
								</a>
							</div>
