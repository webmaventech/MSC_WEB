...
<!-- Mirrored from responsivewebinc.com/premium/ericka351/orange/features1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Jan 2015 10:27:44 GMT -->
<head>
		<meta charset="utf-8">
		<!-- Title here -->
		<title>Features - Ericka</title>
                  ...
                  <div class="col-md-12">
                     ...
                     <div class="ifeature">
                        <div class="ifeat">
                           <div class="row">
                              ...
                              <div class="col-md-6 col-sm-6">
                                    ...
                                    <p>Fusce imperdiet ornare dignissim. Donec aliquet convallis tortor, et placerat quam posuere posuere. Morbi tincidunt posuere turpis eu laoreet  malesuada eros nec odio consect eturegestas et netus et in dictum nisi vehicula onsectetur malesuada eros nec odio consect eturegestas et netus et in dictu.</p>
                                    <div class="button"><a href="#">Try it Now</a></div>
                              </div>
                              <div class="col-md-6 col-sm-6">
                                 <img src="img/work/1.jpg" alt="" class="img-responsive" />
                              </div>
                        ...
                        <div class="ifeat">
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <img src="img/work/2.jpg" alt="" class="img-responsive" />
                              </div>
                              <div class="col-md-6 col-sm-6">
                        ...
                        <div class="ifeat">
                           <div class="row">
                              ...
                              <div class="col-md-6 col-sm-6">
                                 <img src="img/work/3.jpg" alt="" class="img-responsive" />
                              </div>
                              <div class="clearfix"></div>
                           </div>
                        </div>
