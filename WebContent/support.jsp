...
<!-- Mirrored from responsivewebinc.com/premium/ericka351/orange/support.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Jan 2015 10:26:56 GMT -->
<head>
		<meta charset="utf-8">
		<!-- Title here -->
		<title>Support - Ericka</title>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                           ...
                           <div class="scontact">
                              ...
                              <i class="fa fa-phone"></i> Phone<strong>:</strong> 123-456-7890<br />
                              <i class="fa fa-envelope-o"></i> Email<strong>:</strong> something@gmail.com<br />
                              <i class="fa fa-home"></i> Address<strong>:</strong> 12, Srtington Street, NY 
                              <!-- Button -->
